...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 345.0, 245.0, 75.0, 20.0 ],
					"style" : "",
					"text" : "route int"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 435.0, 350.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 220.0, 39.0, 20.0 ],
					"style" : "",
					"text" : "qlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.0, 200.0, 29.5, 20.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 315.0, 290.0, 32.0, 20.0 ],
					"style" : "",
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 410.0, 248.0, 20.0 ],
					"style" : "",
					"text" : "test.assert clojure-test:Evaluate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 75.0, 50.5, 20.0 ],
					"style" : "",
					"text" : "b 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 395.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 370.0, 111.0, 20.0 ],
					"style" : "",
					"text" : "test.terminate"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "cassiel.ruby",
					"text" : "CheckConsoleClear clojure-test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 180.0, 205.0, 20.0 ],
					"style" : "",
					"text" : "(.outlet max/maxObject 0 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 210.0, 212.0, 20.0 ],
					"style" : "",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 7/Packages/max-test-nick/patchers/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
