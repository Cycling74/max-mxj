...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 225.0, 155.0, 20.0 ],
					"style" : "s-r",
					"text" : "s NewerFormat.LOADED"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 150.0, 130.0, 68.0, 20.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 10.0, 10.0, 118.0, 20.0 ],
					"style" : "",
					"text" : "mxj NewerFormat",
					"varname" : "testob"
				}
