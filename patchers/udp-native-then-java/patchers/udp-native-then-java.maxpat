...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 20.0, 156.0, 54.0 ],
					"style" : "cassiel.comment",
					"text" : "Loading Java networking after this was flagged as a fail"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 420.0, 111.0, 20.0 ],
					"style" : "",
					"text" : "test.terminate"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "cassiel.ruby",
					"text" : "CheckConsoleClear udp-native-then-java"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 160.0, 119.0, 20.0 ],
					"style" : "s-r",
					"text" : "r java-udp.DONE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 185.0, 104.0, 20.0 ],
					"style" : "",
					"text" : "load java-udp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 25.0, 169.0, 20.0 ],
					"style" : "",
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/GITHUB/cassiel/max-mxj/projects/udp-native-then-java/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
