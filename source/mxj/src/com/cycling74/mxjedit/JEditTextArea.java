...
public class JEditTextArea extends JComponent
{
    ...
    MXJEditListener undo_listener = null;
	/**
	...
	public JEditTextArea(MXJEditor peer)
	{
	this(TextAreaDefaults.getDefaults());
		this.peer = peer;
	...
	public JEditTextArea(TextAreaDefaults defaults)
	{
		...
		addKeyListener(defaults.inputHandler);//added by toph
		// Load the defaults
		...
		undo_listener = new MXJEditListener();
		getDocument().addUndoableEditListener(undo_listener);
	...
	public int _offsetToX(int line, int offset)
	{
		...
		else
		{
			...
			for(;;)
			{
				...
				//commented out by toph to get rid of deprecation
				//if(id == Token.NULL)
	 ...
	 */
	 /* we want swing to handle this stuff actually so we don't have to hack accelerators --toph
	public void processKeyEvent(KeyEvent evt)
	{
		if(inputHandler == null)
			return;
		//		((MXJEditor)getParent()).processKeyEvent(evt);
		switch(evt.getID())
		{
...
*/
	...
	class FocusHandler implements FocusListener
	{
		...
		{
			//System.err.println("TA Focus gained");
		...
		{
			//System.err.println("TA focues lost");
    ...
    protected class MXJEditListener
