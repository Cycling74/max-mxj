...
{
    //platform independent shortcut mask (command on Apple ?? on PC ) - toph
	...
	public void addDefaultKeyBindings()
	{
		...
		//emacs key bindings for toph on OSX
		if(MaxSystem.isOsMacOsX())
		{
			addKeyBinding("C+A",HOME);
			addKeyBinding("C+E",END);
			addKeyBinding("C+K",KILL);
			addKeyBinding("C+Y",YANK);
			addKeyBinding("C+V",NEXT_PAGE);
		}
		
		//these dont work -toph
		//addKeyBinding("M+V",PREV_PAGE);
		//addKeyBinding("MS+<",DOCUMENT_HOME);
		//addKeyBinding("MS+>",DOCUMENT_END);
		//addKeyBinding("C+X C+S",HOME);
		//		addKeyBinding(getKeyStroke(KeyEvent.VK_N,Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()),CUT);
	...
	{
		//System.out.println("ho: "+evt.toString());
		int modifiers = evt.getModifiers();
