...
public class TextAreaPainter extends JComponent implements TabExpander
{
    ...
    public TextAreaPainter(JEditTextArea textArea, TextAreaDefaults defaults)
	{
	    ...
	    _hints = new HashMap();
	    _hints.put(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_OFF);
	    _hints.put(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_OFF);	    
