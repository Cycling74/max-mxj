...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 446.068756, 221.910187, 163.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.617752, 256.898193, 75.0, 22.0 ],
					"style" : "",
					"text" : "viewsource"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 817.798035, 349.664673, 37.0, 33.0 ],
					"style" : "",
					"text" : "bbn \rc74"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 91.179207, 233.556885, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.179207, 259.682648, 60.0, 22.0 ],
					"style" : "",
					"text" : "radix $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.077423, 281.766479, 515.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.077423, 14.173653, 481.0, 181.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.752563, 247.730545, 99.0, 22.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.550623, 133.407181, 40.0, 22.0 ],
					"style" : "",
					"text" : "jam 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 138.72316, 160.469193, 39.0, 22.0 ],
									"style" : "",
									"text" : "t 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.903955, 106.497627, 34.0, 22.0 ],
									"style" : "",
									"text" : "- 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.903955, 160.469193, 55.0, 22.0 ],
									"style" : "",
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 64.401131, 237.966827, 32.0, 22.0 ],
									"style" : "",
									"text" : "int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.903955, 199.218002, 32.0, 22.0 ],
									"style" : "",
									"text" : "int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.903955, 268.412323, 52.5, 22.0 ],
									"style" : "",
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 30.903955, 78.819908, 127.0, 22.0 ],
									"style" : "",
									"text" : "t i b"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.903955, 132.791473, 48.0, 22.0 ],
									"style" : "",
									"text" : "uzi"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 30.903955, 51.909954, 72.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 314.752563, 221.910187, 102.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 52.0, 161.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 28.550623, 220.736526, 43.0, 22.0 ],
					"style" : "",
					"text" : "/ 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 114.972389, 108.760483, 50.0, 22.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.077965, 108.760483, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 70.077965, 132.233536, 64.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 70.077965, 158.053894, 91.0, 22.0 ],
					"style" : "",
					"text" : "counter 9999"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.077965, 186.221558, 58.0, 22.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 70.077965, 300.676636, 126.0, 29.0 ],
					"style" : "",
					"text" : "mxj fibonacci"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.44072, 187.395203, 104.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 55.0, 34.0, 47.0 ],
					"style" : "",
					"text" : "i love mxj"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.06118, 391.874237, 756.0, 22.0 ],
					"style" : "",
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 38.050621, 154.532928, 79.577965, 154.532928 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 38.050621, 244.209579, 25.18354, 244.209579, 25.18354, 101.892212, 124.472389, 101.892212 ],
					"source" : [ "obj-13", 0 ]
				}
