...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 384.342224, 367.808502, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.342224, 365.308502, 79.0, 25.0 ],
					"style" : "",
					"text" : "start dsp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.456306, 279.49472, 78.0, 22.0 ],
					"style" : "",
					"text" : "viewsource"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 68.462128, 161.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.555824, 166.893143, 81.0, 22.0 ],
					"style" : "",
					"text" : "0.75 0.75 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 337.660187, 209.044861, 79.0, 22.0 ],
					"style" : "",
					"text" : "toggleseq $1"
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 386.053528, 106.627373, 40.0, 23.0 ],
									"style" : "",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 321.162537, 142.448669, 60.0, 23.0 ],
									"style" : "",
									"text" : "float 1."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 386.053528, 172.269958, 43.0, 23.0 ],
									"style" : "",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 280.317413, 205.091248, 45.0, 23.0 ],
									"style" : "",
									"text" : "* 1.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 280.317413, 177.319397, 60.0, 23.0 ],
									"style" : "",
									"text" : "float 1."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 386.053528, 67.494293, 41.0, 23.0 ],
									"style" : "",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 280.317413, 102.840302, 53.0, 23.0 ],
									"style" : "",
									"text" : "uzi 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 280.317413, 264.422058, 83.0, 23.0 ],
									"style" : "",
									"text" : "zl group 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 27.353729, 159.646393, 61.0, 23.0 ],
									"style" : "",
									"text" : "* 0.125"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 125.05928, 59.920151, 41.0, 23.0 ],
									"style" : "",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 27.353729, 189.942963, 35.0, 23.0 ],
									"style" : "",
									"text" : "+ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 27.353729, 130.612167, 76.0, 23.0 ],
									"style" : "",
									"text" : "random 64"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "int" ],
									"patching_rect" : [ 27.353729, 99.05323, 52.0, 23.0 ],
									"style" : "",
									"text" : "uzi 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 27.353729, 217.714828, 75.0, 23.0 ],
									"style" : "",
									"text" : "zl group 8"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 395.553528, 88.0, 395.553528, 92.0, 585.0, 92.0, 585.0, 258.0, 353.817413, 258.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
,
					"patching_rect" : [ 101.774269, 197.08168, 53.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.532761, 143.325134, 341.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.046116, 119.757164, 137.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.5, 93.416466, 87.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 511.404114, 231.641968, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.208736, 68.462128, 157.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 256.342224, 312.772766, 45.0, 22.0 ],
					"style" : "",
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 256.342224, 355.308502, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 422.629822, 182.460007, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 422.629822, 224.995773, 66.0, 22.0 ],
					"style" : "",
					"text" : "interval $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 256.495117, 273.531525, 186.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.655334, 93.416466, 292.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.430817, 144.325134, 130.0, 20.0 ],
					"style" : "",
					"text" : "bounce with me"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 19.708736, 266.202271, 265.995117, 266.202271 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 265.842224, 344.674591, 291.842224, 344.674591 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 40.0, 266.202271, 265.995117, 266.202271 ],
					"source" : [ "obj-9", 0 ]
				}
